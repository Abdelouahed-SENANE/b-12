<aside class="flex flex-col z-50 w-64 h-screen fixed top-0 left-0 px-5 py-8  bg-white border-r
        rtl:border-r-0
        rtl:border-l  ">
    <a href="#">
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="-mx-3 space-y-6 ">
            <div class="space-y-3 ">
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform
            ...
            <div class="space-y-3 ">
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform
                        rounded-lg  hover:bg-yellow-300 hover:text-gray-700" href="/admin/reservations">
                    <i class="fa-solid fa-hand text-[20px]"></i>


                    <span class="mx-2 text-sm font-medium">Reservations</span>
                </a>
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform
                        rounded-lg  hover:bg-yellow-300 hover:text-gray-700" href="/admin/routes">
                    <i class="fa-solid fa-route text-[20px]"></i>
                    <span class="mx-2 text-sm font-medium">Routes</span>
                </a>

            </div>
            <div class="absolute bottom-0 left-0 right-0 h-[70px] bg-gray-200">
                <div class="w-full h-full p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-1">
                            <img src="{{ asset('assets/uploads/' . auth()->user()->picture) }}" alt="" class="h-10 w-10
                        rounded-full">
                            <div class="">
                                <h4 class="text-[15px]">{{ auth()->user()->name }}</h4>
                                <span class="text-gray-600 text-[13px]">{{ auth()->user()->email }}</span>
                            </div>
                        </div>
                        <div class="text-gray-500 relative">
                            <button class="block" id="edit_admin">
                                ...
                                ease-in-out
                            hover:text-yellow-400 cursor-pointer"></i>
                            </button>
