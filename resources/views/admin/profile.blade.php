                ...
                <div class=" w-[60%] mx-auto flex  gap-8">
                    <aside class="w-[300px] bg-white p-5 rounded">
                        ...
                        <div class=" fixed top-0 left-0  opacity-0 invisible w-full h-screen z-50"
                            ...
                            <div class="p-2 bg-white w-[450px] fixed  top-[25%] left-[50%] translate-y-[-180%]
                    translate-x-[-50%] z-40 rounded-xl transition-all duration-300 ease-in-out" id="field_img">

                                <div class="flex items-center justify-center w-full">
                                    <form action="/admin/image/{{ auth()->user()->id }}" class="w-full h-full" method="post"
                    ...
                    <main class="flex-grow bg-white p-5 relative rounded">
                        ...
                        <form action="/admin/update/{{ auth()->user()->id }}" method="post">
                            @method('patch')
                            @csrf
                            <div>
                            ...
                            @if($errors->any())
                                <div class="text-rose-500 bg-red-500/10 rounded-xl text-sm p-1">
                                    <p class="my-1 font-semibold text-md">Somethings wrong!</p>
                                    <ul class="ml-7">
                            ...
                            <div class="grid grid-cols-2 gap-7 my-5">
                                <div>
                                    ...
                                    <input type="text" name="name" value="{{ auth()->user()->name }}" id="name" class="block
                            w-full px-5
                            py-2
                            mt-2
                            text-gray-700
                             placeholder-gray-400 bg-white text-sm
                                ...
                                <div>
                                    ...
                                    <input type="text" name="email" id="email" value="{{ auth()->user()->email }}" class="block
                            ...
                            text-gray-700
                             placeholder-gray-400 bg-white text-sm
                                ...
                                <div>
                                    ...
                                    <input type="password" name="password" id="name" value="{{auth()->user()->password}}"
                            ...
                            <div class="flex items-center gap-3 absolute bottom-8 right-5">
                                <input type="submit" name="update" id="" value="update" class="bg-yellow-400 py-1.5 px-5
                        rounded-3xl block
                        cursor-pointer">
                                <a href="/admin/dashboard" class="block bg-gray-400 text-white py-1.5 px-5
                        rounded-3xl">Cancel</a>
                            </div>
                        </form>
                    </main>
                </div>
