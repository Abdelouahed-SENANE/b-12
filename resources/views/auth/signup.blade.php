...
<section class="bg-white relative">
    ...
    <div class="flex justify-center min-h-screen">
        <div class="hidden bg-cover lg:block lg:w-2/5" style="background-image: url('{{ asset('assets/images/taxi.jpg') }}')"></div>
                ...
                <div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-3 md:flex md:items-center md:-mx-2">
                            <button class="flex justify-center w-full px-6 py-3  rounded-lg
                            ...
                            <button class="flex justify-center w-full px-6 py-3 mt-4 text-yellow-400 border
                    ...
                    <div class="flex w-[100%] gap-20 relative form active">
                        <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2" action="/passenger" method="POST">
                            @csrf
                            ...
                            <div>
                                <label class="block mb-2 text-sm text-gray-600 ">
                                    Name</label>
                                <input type="text" placeholder="John" name="name" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white
                            ...
                            <div>
                                <label class="block mb-2 text-sm text-gray-600 ">
                                    Email</label>
                                <input type="email" name="email" placeholder="test@test.fr" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white
                                        border border-gray-200 rounded-lg dark:placeholder-gray-600
                                        focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring-yellow-300
                                        focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>
                            <div>
                                ...
                                <input type="password" placeholder="********" name="password" class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white
                                        border border-gray-200 rounded-lg dark:placeholder-gray-600
                                        focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring-yellow-300
                                        focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>
                            ...
                            <button class="flex items-center justify-center w-full px-6 py-3 text-sm tracking-wide
                    ...
                    <div class="flex w-[100%] gap-20 relative form ">
                        <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2" action="/driver" method="POST">
                            @csrf
                            <div class="opacity-0
                                    hidden invisible absolute left-0">
                            ...
                            <div>
                                <label class="block mb-2 text-sm text-gray-600 ">
                                    Description</label>
                                <input type="text" name="description" placeholder="Description..." class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white
                                        border border-gray-200 rounded-lg dark:placeholder-gray-600
                                        focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring-yellow-300
                                        focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>
                            <div>
                                ...
                                <input type="text" name="registration" placeholder="Immatriculation..." class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white
                                        border border-gray-200 rounded-lg dark:placeholder-gray-600
                                        focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring-yellow-300
                                        focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>
                            <div>
                                ...
                                <input type="text" name="type_car" placeholder="Type..." class="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white
                                        border border-gray-200 rounded-lg dark:placeholder-gray-600
                                        focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring-yellow-300
                                        focus:outline-none focus:ring focus:ring-opacity-40" />
                            </div>
                            <div>
                                ...
                                <label for="mode" class="block text-sm font-medium text-gray-900 my-1.5">Mode Payment</label>
                                <select id="mode" name="mode" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-yellow-300
